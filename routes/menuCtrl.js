        ...
        */
        ...
        router.get('/getMenuListByChefId',async(req,res,next) =>{
            try {
               ...
               let criteria = {chef_id:headers.chef_id};
               criteria.publicIndArr =  await chefMenuService.getPublicIndStatusArr(req.user_id);
                res.json(await  chefMenuService.getMenuListByChefId(criteria));
            }catch (e) {
                next(e);
            }
        })
