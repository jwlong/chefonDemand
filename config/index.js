const config = {
    ...
    WHITE_LIST_URL:["/user/userLogin",'/user/refreshAccessToken',
        ...
        '/menu/getMenuListByRating','/menu/getMenuListByChefsChoice','/chef/findChefByFilters','/menu/findMenuByFilters','/menu/getMenuListByChefId','/order/updateOrderGuestSelectionByOrderId'],
